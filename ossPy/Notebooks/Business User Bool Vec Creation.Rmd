...
```{python}
tableCleanedFullNameCounts.head(20)
```
...
LabeledBoolVec=np.any([fixedDataframe['household'],fixedDataframe['is_business'],fixedDataframe['is_academic'],fixedDataframe['is_gov']],axis=0)
