...
In total, we identified 40,273 users in the academic sector. Of these, 38,709 are matched to a specific institution, while 1,564 are categorized as miscellaneous students (removed from further analysis). We found that the United States is predominant: about a third of the institutions represented in our data are in the U.S., and users from those institutions make up around 55 percent of total users in the academic sector. Below we've included some figures and searchable tables exploring our data broken down by university and by country, as well as universities in the U.S. specifically.
