...
Generally, we found that users based in the United States are most prominently represented. Roughly one-third of the institutions represented in our data are from the US and users from those institutions make up around 55 percent of total users in the academic sector. In this figure, you can see that...  
...
As we can see in the first figure, 
