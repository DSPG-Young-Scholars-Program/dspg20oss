...
```{r stats_new, message = FALSE, results=FALSE, warning = FALSE, echo=FALSE}
...
```{r, us_universities, fig.height = 7,  warning = FALSE, echo=FALSE}
...
```{r, countries_users, fig.height = 7,  warning = FALSE, echo=FALSE}
