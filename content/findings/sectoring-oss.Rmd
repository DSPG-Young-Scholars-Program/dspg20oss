...
<center>
![](/dspg20oss/findings/sectoring-oss_files/dspg-small.jpg)
</center>
...
<center>
![](/dspg20oss/findings/sectoring-oss_files/oss.png)
</center>
...
<center>
![](/dspg20oss/findings/sectoring-oss_files/microsoft-example.png)

![](/dspg20oss/findings/sectoring-oss_files/ucsd-example.png)
...
combined_user_data <- readRDS(paste0(here::here(), "/data/combined_user_data.RDS"))

# household 
household <- read.csv(paste0(here::here(), "/ossPy/keyFiles/individualKeys.csv"), header=FALSE)
household <- household %>% 
  rename(strings = V1) %>% 
...
# null values 
null_values <- read.csv(paste0(here::here(), "/ossPy/keyFiles/nullKeys.csv"), header=FALSE)
...
legal_entities <- read.csv(paste0(here::here(), "/ossPy/keyFiles/curatedLegalEntitesRaw.csv"), header=FALSE)
...
symbol_strings <- read.csv(paste0(here::here(), "/ossPy/keyFiles/symbolRemove.csv"), header=FALSE)
...
curated_domains <- read.csv(paste0(here::here(), "/ossPy/keyFiles/curatedDomains.csv"), header=FALSE)
...
<center>
![](/dspg20oss/findings/sectoring-oss_files/wordcloud.svg){width=80%}
</center>
...
<center>
![](/dspg20oss/findings/sectoring-oss_files/14_all_cities_by_continent_degree.png){width=70%}
</center>
...
<center>
![](/dspg20oss/findings/geographic_files/14_legend.png){width=95%}
