...
#### We used GHTorrent (a dataset of ~2.1 million GitHub users with <br/> email, affiliation and location data) to categorize users into sectors
...
#### Improve the government, non-profit and household classification systems 
