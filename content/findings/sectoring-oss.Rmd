...
description: 'Symposium Presentation of the 2020 DSPG OSS Project'
weight: 1
...
#### Crystal Zang, Morgan Klutzke, Daniel Bullock, Brandon Kramer, Gizem Korkmaz, <br> José Bayoán Santiago Calderón, Aaron Schroeder, and Sallie Keller
...
<center>
![](/findings/sectoring-oss_files/ncses-large.png)
</center>
...
OSS <- data.frame(
    ...
    DataSource = c(
      ...
      "GHTorrent", "GHTorrent", "GHTorrent", "GHTorrent", "GHTorrent", "GHTorrent", "GHTorrent",
      "GitHub","GitHub", "GitHub","GitHub","GitHub",
      "DataHub Domain List",  "DataHub Domain List", "DataHub Domain List", 
      
      "Gleif's Legal Entity List",  "Gleif's Legal Entity List", "Gleif's Legal Entity List", 
    ...
    Variables = c(
       #academic
        "username", "affiliation", "city", "state","country code", "latitude",  "longitude",  #7
        ...
        "email domain", "organization", "organization type",   #7
         "legal entity form", "entity abbreviation", "country",    #7
        
        #gov
        "username","affiliation","city","state","country code",  "latitude",  "longitude", 
...
#### We used GHTorrent data to categorize users into sectors <br/> (dataset of ~2.1 million GitHub users with email, affiliation and location data) 

<center>
![](/findings/sectoring-oss_files/ghtorrent.png) 
</center>

#### We also used multiple publicly available datasources to help <br/> match users to existing organizations within each sector 
#### (see our [Data & Methods](/methods/) page for more details)
...
#### The problem is that our text data are very messy 

<center>
![](/findings/sectoring-oss_files/messy-data.png)
![](/findings/sectoring-oss_files/messy-email.png)
</center>
...
```{r sectoring, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r business, echo=FALSE, message=FALSE, warning=FALSE}
...
<iframe  title="YouTube video player" width="480" height="390" src="https://www.youtube.com/watch?v=KHokyhsd6IM" frameborder="0" allowfullscreen></iframe>
