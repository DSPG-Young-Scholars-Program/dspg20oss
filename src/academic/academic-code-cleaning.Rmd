...
New total is 35,089 users matched to academic institutions.
...
ggplot(df_sorted[(.N-50):.N, ]) +
  ...
  #geom_segment(data = df_sorted, mapping = aes(x=x, xend=x, y=0, yend=y), inherit.aes = FALSE)
  coord_flip()
```
