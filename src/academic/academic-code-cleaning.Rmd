...
ggplot(data = academic_counts_sorted[(.N-10):.N,]) + geom_col(mapping = aes(organization, n, fill = n)) + labs(x = "Academic institution", y = "User count", title = "Top 10 universities by users") + coord_flip()
```
