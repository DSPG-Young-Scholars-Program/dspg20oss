...
org_counts <- users_gh %>%
  ...
  dt_mutate(organization = str_replace_all(organization, "\\b(inc.|inc)\\b", "")) %>%
...
Check how many academic institutions are represented
...
university of michigan, sun yat-sen university, texas a&m university, university of college london, university of tokyo, university of texas

```{r}
ggplot(data = overlap[1:10,]) + geom_col(mapping = aes(n, reorder(organization, n)))
```
