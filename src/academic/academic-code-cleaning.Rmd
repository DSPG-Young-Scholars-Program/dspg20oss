...
match_domain <- function(emails) {
  print(institutions_hipolabs[domains == emails])
...
dt_mutate(institutions_hipolabs, institution = str_to_lower(institution))
...
Making a table to see what isn't caught by hipolabs
...
Comparing github user emails with university domains
